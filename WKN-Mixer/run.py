...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='PatchSVDD')
    ...
    parser.add_argument('--model', type=str, default='deepSVDD',
                        help='model name, options: [Autoformer, Transformer, TimesNet, deepSVDD]')
    parser.add_argument('--objective', type=str, default='one-class',
                        help='Specify Deep SVDD objective ("one-class" or "soft-boundary").')
    parser.add_argument('--net_name', type=str, required=True, default='patchtst', help='options: [patchtst]')
    ...
    parser.add_argument('--ae_lr_milestone', default=(0,),
    ...
    parser.add_argument('--lr_milestone', default=(0,),
                        help='Lr scheduler milestones at which lr is multiplied by 0.1. Can be multiple and must be increasing.')
    # forecasting task
    ...
    parser.add_argument('--patch_len', type=int, default=24, help='patch_len')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_dm{}_el{}_df{}_pl{}_st{}_aelr{}_lr{}_bs{}_aeep{}_ep{}'.format(
                args.model,
                args.data,
                args.net_name,
                args.d_model,
